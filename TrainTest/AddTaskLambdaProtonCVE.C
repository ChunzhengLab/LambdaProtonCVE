...
{  
  ...
  if (doNUE) {
    if (period.EqualTo("LHC10h")) {
      fNUEFile = TFile::Open("/Users/wangchunzheng/works/Experiments/LambdaProtonCVE/CalibFiles/LHC10h/Run1NUE.root","READ");
      fListNUE = dynamic_cast <TList*> (fNUEFile->Get("listNUE"));
    }
    if (period.EqualTo("LHC15o")) {
      fNUEFile = TFile::Open("/Users/wangchunzheng/works/Experiments/LambdaProtonCVE/CalibFiles/LHC15o/efficiencyBothpol.root","READ");
      fListNUE = dynamic_cast <TList*> (fNUEFile->Get("fMcEffiHij"));
    }
    if (period.EqualTo("LHC18q")) {
      fNUEFile = TFile::Open("/Users/wangchunzheng/works/Experiments/LambdaProtonCVE/CalibFiles/LHC18q/efficiencyBothpol18qnew.root","READ");
      fListNUE = dynamic_cast <TList*> (fNUEFile->Get("fMcEffiHij"));
    }
    if (period.EqualTo("LHC18r")) {
      fNUEFile = TFile::Open("/Users/wangchunzheng/works/Experiments/LambdaProtonCVE/CalibFiles/LHC18r/efficiencyBothpol18qnew.root","READ");
      fListNUE = dynamic_cast <TList*> (fNUEFile->Get("fMcEffiHij"));
    }
    if(fListNUE) {
  ...
  if (doNUA) {
    if (period.EqualTo("LHC10h")) {
      if(filterBit == 1)   fNUAFile = TFile::Open("/Users/wangchunzheng/works/Experiments/LambdaProtonCVE/CalibFiles/LHC10h/10hNUAFB1.root","READ");
      if(filterBit == 768) fNUAFile = TFile::Open("/Users/wangchunzheng/works/Experiments/LambdaProtonCVE/CalibFiles/LHC10h/10hNUAFB768.root","READ");
      fListNUA = dynamic_cast <TList*> (fNUAFile->Get("10hListNUA"));
    }
    if (period.EqualTo("LHC15o")) {
      fNUAFile = TFile::Open("/Users/wangchunzheng/works/Experiments/LambdaProtonCVE/CalibFiles/LHC15o/wgtPion_NUAFB768DeftwPUcut_LHC15op2_24Aug2021.root","READ");
      fListNUA = dynamic_cast <TList*> (fNUAFile->Get("15oListNUA"));
    }
    if (period.EqualTo("LHC18q")) {
      fNUAFile = TFile::Open("/Users/wangchunzheng/works/Experiments/LambdaProtonCVE/CalibFiles/LHC18q/WgtsNUAChargeAndPion_LHC18qPass3_FB768_AlexPU_DeftMode_Sept2021NoAvgQ.root","READ");
      fListNUA = dynamic_cast <TList*> (fNUAFile->Get("fNUA_ChPosChNeg"));
    }
    if (period.EqualTo("LHC18r")) {
      fNUAFile = TFile::Open("/Users/wangchunzheng/works/Experiments/LambdaProtonCVE/CalibFiles/LHC18r/WgtsNUAChargeAndPion_LHC18rPass3_FB768_AlexPU_DeftMode_Sept2021NoAvgQ.root","READ");
      fListNUA = dynamic_cast <TList*> (fNUAFile->Get("fNUA_ChPosChNeg"));
    }
    if(fListNUA) {
  ...
  if (v0calibOn) {
    if (period.EqualTo("LHC10h")) {
      fVZEROCalibFile = TFile::Open("/Users/wangchunzheng/works/Experiments/LambdaProtonCVE/CalibFiles/LHC10h/10hQnCalib.root","READ");
      fVZEROCalibList = dynamic_cast <TList*> (fVZEROCalibFile->Get("10hlistqncalib"));
    }
    if (period.EqualTo("LHC15o")) {
      fVZEROCalibFile = TFile::Open("/Users/wangchunzheng/works/Experiments/LambdaProtonCVE/CalibFiles/LHC15o/VZEROCalibFile.root","READ");
      fVZEROCalibList = dynamic_cast <TList*> (fVZEROCalibFile->Get("VZEROCalibList"));
    }
    if (period.EqualTo("LHC18q")) {
      fVZEROCalibFile = TFile::Open("/Users/wangchunzheng/works/Experiments/LambdaProtonCVE/CalibFiles/LHC18q/calibSpq2V0C18qP3.root","READ");
      fVZEROCalibList = dynamic_cast <TList*> (fVZEROCalibFile->Get("fWgtsV0ZDC"));
    }
    if (period.EqualTo("LHC18r")) {
      fVZEROCalibFile = TFile::Open("/Users/wangchunzheng/works/Experiments/LambdaProtonCVE/CalibFiles/LHC18r/calibSpq2V0C18rP3.root","READ");
      fVZEROCalibList = dynamic_cast <TList*> (fVZEROCalibFile->Get("fWgtsV0ZDC"));
    }
    if(fVZEROCalibList) {
  ...
  if (zdccalibOn) {
    if (period.EqualTo("LHC10h")) {
      fZDCCalibFile = TFile::Open("/Users/wangchunzheng/works/Experiments/LambdaProtonCVE/CalibFiles/LHC10h/ZDCCalibFile.root","READ");
      fZDCCalibList = dynamic_cast <TList*> (fZDCCalibFile->Get("ZDCCalibList"));
    }
    // if (period.EqualTo("LHC15o")) {
    //   fZDCCalibFile = TFile::Open("/Users/wangchunzheng/works/Experiments/LambdaProtonCVE/CalibFiles/LHC15o/10hQnCalib.root","READ");
    //   fZDCCalibList = dynamic_cast <TList*> (fZDCCalibFile->Get("10hlistqncalib"));
    // }
    if (period.EqualTo("LHC18q")) {
      fZDCCalibFile = TFile::Open("/Users/wangchunzheng/works/Experiments/LambdaProtonCVE/CalibFiles/LHC18q/RecenteringResultFinal_2018q.root","READ");
      fZDCCalibList = dynamic_cast <TList*> (fZDCCalibFile->Get("fOutputRecenter"));
    }
    if (period.EqualTo("LHC18r")) {
      fZDCCalibFile = TFile::Open("/Users/wangchunzheng/works/Experiments/LambdaProtonCVE/CalibFiles/LHC18r/RecenteringResultFinal_2018r.root","READ");
      fZDCCalibList = dynamic_cast <TList*> (fZDCCalibFile->Get("fOutputRecenter"));
    }
    if(fZDCCalibList) {

...
class AliAnalysisTaskLambdaProtonCVE : public AliAnalysisTaskSE {
 public:
  ...
  // Plane Switch
  void IfUseVZEROPlane(bool bVZEROPlane) { this->IsUseVZEROPlane = bVZEROPlane; }
  void IfUseZDCPlane(bool bZDCPlane) { this->IsUseZDCPlane = bZDCPlane; }
  // Plane
  ...
  void IfFillDiffResult(bool bFillDiffResult) {this->IsFillDiffResult = bFillDiffResult;}
  void IfFillDeltaPhiSumPhi(bool bFillDeltaPhiSumPhi) {this->IsFillDeltaPhiSumPhi = bFillDeltaPhiSumPhi;}
 ...
 private:
  ...
  bool IsCheckPIDFlow;
  // Fill Diff Reslut
  bool IsFillDiffResult;
  // Fill C(delta_phi)
  bool IsFillDeltaPhiSumPhi;
  ...
  std::vector<double> vecLambdaEta;
  ...
  // diff pt
  TProfile* fProfileDelta_dpt_Lambda_hPos;            //
  TProfile* fProfileDelta_dpt_Lambda_hNeg;            //
  TProfile* fProfileDelta_dpt_Lambda_Proton;          //
  TProfile* fProfileDelta_dpt_Lambda_AntiProton;      //
  TProfile* fProfileDelta_dpt_AntiLambda_hPos;        //
  TProfile* fProfileDelta_dpt_AntiLambda_hNeg;        //
  TProfile* fProfileDelta_dpt_AntiLambda_Proton;      //
  TProfile* fProfileDelta_dpt_AntiLambda_AntiProton;  //

  // diff eta
  TProfile* fProfileDelta_deta_Lambda_hPos;            //
  TProfile* fProfileDelta_deta_Lambda_hNeg;            //
  TProfile* fProfileDelta_deta_Lambda_Proton;          //
  TProfile* fProfileDelta_deta_Lambda_AntiProton;      //
  TProfile* fProfileDelta_deta_AntiLambda_hPos;        //
  TProfile* fProfileDelta_deta_AntiLambda_hNeg;        //
  TProfile* fProfileDelta_deta_AntiLambda_Proton;      //
  TProfile* fProfileDelta_deta_AntiLambda_AntiProton;  //

  // mean pt
  TProfile* fProfileDelta_mpt_Lambda_hPos;            //
  TProfile* fProfileDelta_mpt_Lambda_hNeg;            //
  TProfile* fProfileDelta_mpt_Lambda_Proton;          //
  TProfile* fProfileDelta_mpt_Lambda_AntiProton;      //
  TProfile* fProfileDelta_mpt_AntiLambda_hPos;        //
  TProfile* fProfileDelta_mpt_AntiLambda_hNeg;        //
  TProfile* fProfileDelta_mpt_AntiLambda_Proton;      //
  TProfile* fProfileDelta_mpt_AntiLambda_AntiProton;  //

  // C(phi)
  TH2F* fHistDelPhi_Lambda_hPos;            //
  TH2F* fHistDelPhi_Lambda_hNeg;            //
  TH2F* fHistDelPhi_Lambda_Proton;          //
  TH2F* fHistDelPhi_Lambda_AntiProton;      //
  TH2F* fHistDelPhi_AntiLambda_hPos;        //
  TH2F* fHistDelPhi_AntiLambda_hNeg;        //
  TH2F* fHistDelPhi_AntiLambda_Proton;      //
  TH2F* fHistDelPhi_AntiLambda_AntiProton;  //

  TH2F* fHistSumPhiTPC_Lambda_hPos;            //
  TH2F* fHistSumPhiTPC_Lambda_hNeg;            //
  TH2F* fHistSumPhiTPC_Lambda_Proton;          //
  TH2F* fHistSumPhiTPC_Lambda_AntiProton;      //
  TH2F* fHistSumPhiTPC_AntiLambda_hPos;        //
  TH2F* fHistSumPhiTPC_AntiLambda_hNeg;        //
  TH2F* fHistSumPhiTPC_AntiLambda_Proton;      //
  TH2F* fHistSumPhiTPC_AntiLambda_AntiProton;  //

  TH2F* fHistSumPhiV0C_Lambda_hPos;            //
  TH2F* fHistSumPhiV0C_Lambda_hNeg;            //
  TH2F* fHistSumPhiV0C_Lambda_Proton;          //
  TH2F* fHistSumPhiV0C_Lambda_AntiProton;      //
  TH2F* fHistSumPhiV0C_AntiLambda_hPos;        //
  TH2F* fHistSumPhiV0C_AntiLambda_hNeg;        //
  TH2F* fHistSumPhiV0C_AntiLambda_Proton;      //
  TH2F* fHistSumPhiV0C_AntiLambda_AntiProton;  //

  TH2F* fHistSumPhiV0A_Lambda_hPos;            //
  TH2F* fHistSumPhiV0A_Lambda_hNeg;            //
  TH2F* fHistSumPhiV0A_Lambda_Proton;          //
  TH2F* fHistSumPhiV0A_Lambda_AntiProton;      //
  TH2F* fHistSumPhiV0A_AntiLambda_hPos;        //
  TH2F* fHistSumPhiV0A_AntiLambda_hNeg;        //
  TH2F* fHistSumPhiV0A_AntiLambda_Proton;      //
  TH2F* fHistSumPhiV0A_AntiLambda_AntiProton;  //
